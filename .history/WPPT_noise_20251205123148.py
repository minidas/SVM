...
def find_noise_tolerance_for_witness(W, ent_obj, n, noise_type='white', noise_tolerance=1e-6, max_iterations=50):
...
def main():
    ...
    for a in t_list:
        ...
        if a % turns == 0:
            ...
            noise_data, max_noise = find_noise_tolerance_for_witness(W, test_ob, n, noise_type=noise_type)
