...
def main():
    ...
    for step_idx, step_data in noise_results.items():
        ...
        fname = generate_noise_filename(n, limit, turns, step_idx, noise_type=noise_type)
        ...
        # entropy plot
        # entropy plot: only if computed
        if args.compute_entropy and 'entropy' in df.columns:
            plt.figure(figsize=(8, 5))
